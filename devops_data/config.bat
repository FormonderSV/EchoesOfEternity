...
set EnginePath=F:\Engine\UE_5.2
set VersionSelector=C:\Epic Games\Launcher\Engine\Binaries\Win64\UnrealVersionSelector.exe
...
set ProjectPureName=EchoesOfEternity
...
set COPYRIGHT_LINE=// Echoes of Eternity game. Copyright Formonder. All Rights Reserved.
